...
export const RATES: Record<RateKey, Rate> = {
  us: { name: 'Mỹ (USA)', flag: '🇺🇸', base: 120000, perKg: 290000, eta: '4–6 ngày' },
  au: { name: 'Úc', flag: '🇦🇺', base: 110000, perKg: 250000, eta: '3–5 ngày' },
  ca: { name: 'Canada', flag: '🇨🇦', base: 130000, perKg: 310000, eta: '5–7 ngày' },
  eu: { name: 'Châu Âu (EU/UK)', flag: '🇪🇺', base: 120000, perKg: 270000, eta: '4–6 ngày' },
  jp: { name: 'Nhật & Hàn', flag: '🇯🇵', base: 90000, perKg: 190000, eta: '2–4 ngày' },
  sg: { name: 'Singapore', flag: '🇸🇬', base: 80000, perKg: 160000, eta: '2–3 ngày' },
};
