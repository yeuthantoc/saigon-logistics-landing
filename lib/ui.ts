...
export const BTN_BASE =
  'group inline-flex items-center justify-center gap-2 rounded-xl border-2 border-ink px-5 py-3 text-[15px] font-bold font-sans transition-all duration-100 shadow-hard-sm hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-hard-hover active:translate-x-[2px] active:translate-y-[2px] active:shadow-hard-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink focus-visible:ring-offset-2';
